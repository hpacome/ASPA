...
namespace ASPA.DAL.Repository
{
    public class RepositoryBase<T, TKey> : IRepositoryBase<T, TKey> where T : class, new()
    {
        ...
        public void Create(List<T> entities)
        {
            ...
            {
                throw new Exception($"Insert object failed ", ex);
            }
        }
        ...
        int IRepositoryBase<T, TKey>.Delete(T entity)
        {
            ...
            {
                throw new Exception($"Delete entity failed - ID {entity} ", ex);
            }
        }
        ...
        IEnumerable<T> IRepositoryBase<T, TKey>.GetAll()
        {
            ...
            {
                throw new Exception("Cannot retrieve the list of entities ", ex);
            }
        }
        ...
        T IRepositoryBase<T, TKey>.GetByFilter(System.Linq.Expressions.Expression<Func<T, bool>> filter)
        {
            ...
            {
                throw new Exception("Cannot retrieve the filtered entity ", ex);
            }
        }
        ...
        int IRepositoryBase<T, TKey>.GetCount(System.Linq.Expressions.Expression<Func<T, bool>> filter)
        {
            ...
            {
                throw new Exception("Cannot get the count of the filtered entities ", ex);
            }
        }
        ...
        void IRepositoryBase<T, TKey>.Create(T entity)
        {
            if (entity == null)
            {
                throw new Exception($"Object {nameof(entity)} is null ");
            }
        ...
        public async Task<IEnumerable<T>> CreateRangeAsync(IEnumerable<T> entities)
        {
            if (entities == null)
            {
                throw new Exception($"Object {nameof(entities)} is null ");
            }
            ...
            {
                throw new Exception($"Insert object {nameof(entities)} failed ", ex);
            }
        }
        ...
        async Task<int> IRepositoryBase<T, TKey>.DeleteRangeAsync(System.Linq.Expressions.Expression<Func<T, bool>> filter)
        {
            try
            {
                ...
                if (entities == null) throw new Exception("Object Not Found Exception");
                Entities.RemoveRange(entities);
                return await SaveChangesAsync();
            }
            catch (Exception ex)
            {
                throw new Exception($"Delete entity failed ", ex);
            }
        }
        ...
        public async Task<IEnumerable<T>> UpdateRangeAsync(IEnumerable<T> entities)
        {
            ...
            {
                throw new Exception($"Update object {nameof(entities)} failed ", ex);
            }
        }
